...
class Zombie:
    ...
    def build_behavior_tree(self):
        ...
        c2 = Condition('소년이 약한가?', self.is_boy_weak)
        a4 = Action('소년한테 접근', self.move_to_boy)
        root = SEQ_chase_boy = Sequence('소년을 추적', c1, c2, a4)

        c3 = Condition('소년이 강한가?', self.is_boy_strong)
        a5 = Action('소년에게서 도망', self.run_to_boy)
